...
function Make(Impl) {
  var updateOnScreenState = function (nextState, currentState, _, param) {
    var state = param[/* state */4];
    if (currentState === state[/* onScreenNavigationState */2]) {
      return /* Update */Block.__(0, [/* record */[
                  /* width */state[/* width */0],
                  /* position */state[/* position */1],
                  /* onScreenNavigationState */nextState,
  ...
  var onLayout = function ($$event, param) {
    var state = param[/* state */4];
  ...
  var component = ReasonReact.statefulComponent("AppNavigator");
    ...
    return /* record */[
            ...
            /* willReceiveProps */(function (param) {
                ...
                if (oldLength < newLength) {
                  return /* record */[
                          ...
                          return acc ? Curry._2(Impl[/* compare */0], x1, x2) : /* false */0;
            ...
            /* didUpdate */(function (param) {
                ...
                if (oldLength === newLength) {
                  ...
                  var callback = match$1 !== 0 ? /* None */0 : /* Some */[Curry._1(match[/* update */1], (function (param, param$1) {
                              return updateOnScreenState(navigationState, onScreenNavigationState, param, param$1);
                            }))];
            ...
            /* render */(function (param) {
                ...
                if (onScreenNavigationState) {
                  ...
                  return ReasonReact.element(/* None */0, /* None */0, Curry.app(ReactNative.View[/* make */0], [
                                  ...
                                  /* None */0,
                                  /* None */0,
                                  /* Some */[Curry._1(param[/* update */1], onLayout)],
                                  /* None */0,
                                  /* None */0,
                                  /* None */0,
                                  /* None */0,
  ...
  return /* module */[
          ...
          /* updateOnScreenState */updateOnScreenState,
